...
import { Plus, ArrowLeft, Books, Trophy, Certificate } from '@phosphor-icons/react'
                        ...
                        <Card>
                            <CardContent className="flex items-center gap-4 p-4">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-emerald-500/10">
                                    <Certificate className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                                </div>
                                <div>
                        ...
                        <Card>
                            <CardContent className="flex items-center gap-4 p-4">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-blue-500/10">
                                    <Books className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                                </div>
                                <div>
                            ...
                            <Card className="border-dashed">
                                <CardContent className="flex flex-col items-center justify-center py-12">
                                    <div className="bg-muted mb-3 flex h-12 w-12 items-center justify-center rounded-full">
                                        <Books className="text-muted-foreground h-6 w-6" />
                                    </div>
